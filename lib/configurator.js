...
/**
 * Load the Directives (if they are strings, require them; objects leave alone).
 * @returns {[{Object}]} Array of directives
 * @private
 */
Configurator.prototype.__loadDirectives = function(){
  return _.values(this.__config.directives).map(function(directive){
    if (_.isString(directive)) return require(directive);
    return directive;
  });
};
...
Configurator.prototype.__buildConfiguration = function(){
  return {
    ...
    directives: this.__loadDirectives()
  };
};
