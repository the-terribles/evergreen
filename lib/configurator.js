...
Configurator.prototype.config = function(){
  assert.ok(EvUtils.isNonArrayObject(this.__config), 'Graph has not been rendered (did it error?).');
...
Configurator.prototype.addModule = function(_module){
  ...
  if (_module.hasOwnProperty('directives')){
    ...
    _module.resolvers.forEach(this.addDirective.bind(this));
  }
...
Configurator.prototype.render = function(tree){
  ...
  this.__tree = tree;
  process.nextTick(this.__buildGraph.bind(this));
  return this;
};
