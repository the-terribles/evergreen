...
util.inherits(RequireContentLoader, FileContentLoader);
...
RequireContentLoader.loadJavaScriptFile = function(path, javascript, callback){
  ...
  if (scope.module && scope.module.exports){
    return callback(null, 'application/javascript', scope.module.exports)
  }
 ...
 */
RequireContentLoader.prototype.handleContent = function(path, mimeType, data, callback){
